...
# 添加图例
fig.legend(handles=legend_elements, loc='upper center', bbox_to_anchor=(0.5, 0.01), ncol=4,
           fontsize='large', title_fontsize='large', handlelength=2, handletextpad=1, labelspacing=1.2)

# # 调整子图和画布布局
fig.subplots_adjust(left=0.05, right=0.95, top=0.95, bottom=0.15, wspace=0.3, hspace=0.4)
