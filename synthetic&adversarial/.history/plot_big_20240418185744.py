...
def plot_training_half_moon (ax):
    ...
    for i, (a, b) in enumerate(zip(f1, f2)):
        if majority_minority[i] == 'Female':  # majority实框
            ax.scatter(a*4, b*4, marker='o', color=y_colormap[y[i]], s=200, edgecolor='black', alpha=alpha1)
        else:  # minority虚框
            ax.scatter(a*4, b*4, marker='o', color=y_colormap[y[i]], s=200, edgecolors='black', alpha=alpha1)  # 先画散点
