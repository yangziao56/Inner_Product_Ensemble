...
legend_elements = [
    ...
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='gray', markersize=50, label='Normal Point'),
    plt.Line2D([0], [0], marker='X', color='w', markerfacecolor='gray', markersize=50, label='Outlier')
]
