...
if __name__ == "__main__":
    ...
    for _ in range(n_iters):
        ...
        defense_datainf = accuracy_score(defense_model_datainf.pred(x_adv_test)[1], data.y_test)
        defense_Self_Gradient_Tracing.append(accuracy_score(defense_model_Self_Gradient_Tracing.pred(x_adv_test)[1], data.y_test))
        defense_Self_datainf = accuracy_score(defense_model_Self_datainf.pred(x_adv_test)[1], data.y_test)
