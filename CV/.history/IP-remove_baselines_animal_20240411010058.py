...
parser.add_argument('--dataset', type = str, help = ' cifar10 or cifar100', default = 'Animal10N')
parser.add_argument('--n_epoch', type=int, default=200)#100
...
parser.add_argument('--acc', type = float, default = 80.54) #0.05
...
if __name__ == '__main__':
    ...
    alpha_plan = [0.1] * 60 + [0.01] * 40 + [0.005] * 100
