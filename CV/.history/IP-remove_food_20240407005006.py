...
for _ in range(args.repeat):
    ...
    filename = f"/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/IP_save/IP_sum-{dataset}-{suffix}-{best_acc}.pth"
    torch.save(IP_sum, 'IP_sum-{dataset}-{suffix}-{best_acc}.pth')
