...
for _ in range(args.repeat):
    ...
    filename = f"/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/IP_save/IP_sum-{dataset}-{suffix}-{best_acc}-{args.ensemble_size}-{args.dropout_IP}.pth"
    torch.save(IP_sum, filename)
