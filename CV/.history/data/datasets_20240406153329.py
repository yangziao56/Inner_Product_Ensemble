...
def input_dataset(dataset, noise_type, noise_path, is_human):
    if dataset == 'cifar10':
        ...
        train_dir = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Animal10N/train/')
        test_dir = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Animal10N/test/')
        ...
        train_dir = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Food101N/')
        test_dir = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Food101N/')
        train_meta = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Food101N/meta/verified_train.tsv')
        test_meta = os.path.expanduser('/home/exxact-yza/桌面/Research/Influence_Function/IP_data_sel/cifar-10-100n/data/Food101N/meta/verified_val.tsv')
